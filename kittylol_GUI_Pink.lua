if (game:GetService("CoreGui")):FindFirstChild("kittylol") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).kittylol:Destroy();
	(game:GetService("CoreGui")).ScreenGui:Destroy();
end;
_G.Primary = Color3.fromRGB(255, 105, 180);
_G.Dark = Color3.fromRGB(10, 10, 15);
_G.Third = Color3.fromRGB(255, 20, 147);
...
ImageButton.Image = "rbxassetid://129430365420845";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("kittylol")).Enabled = not (game.CoreGui:FindFirstChild("kittylol")).Enabled;
end);
...
function Update:Notify(desc)
	...
	Image.Name = "Icon";
	Image.Parent = Frame;
	Image.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
	Image.BackgroundTransparency = 1;
	Image.Position = UDim2.new(0, 8, 0, 8);
	Image.Size = UDim2.new(0, 45, 0, 45);
	Image.Image = "rbxassetid://129430365420845";
	Title.Parent = Frame;
	...
	Desc.Text = desc;
	Desc.TextColor3 = Color3.fromRGB(255, 105, 180);
	Desc.TextSize = 12;
...
function Update:StartLoad()
	...
	TitleLoader.Text = "kittylol";
	TitleLoader.Font = Enum.Font.FredokaOne;
	TitleLoader.TextSize = 50;
	TitleLoader.TextColor3 = Color3.fromRGB(255, 105, 180);
	...
	DescriptionLoader.TextColor3 = Color3.fromRGB(255, 105, 180);
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("kittylol/Library/") then
			makefolder("kittylol/Library/");
		end;
		if not isfile(("kittylol/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("kittylol/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("kittylol/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("kittylol/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("kittylol/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	kittylol.Parent = game.CoreGui;
	kittylol.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = kittylol;
	...
	NameHub.Parent = Top;
	NameHub.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
	...
	NameHub.Text = "kittylol";
	NameHub.TextSize = 20;
	NameHub.TextColor3 = Color3.fromRGB(255, 105, 180);
	...
	SubTitle.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
	...
	SubTitle.TextColor3 = Color3.fromRGB(255, 105, 180);
	...
	CloseButton.ImageColor3 = Color3.fromRGB(255, 105, 180);
	...
	ResizeButton.ImageColor3 = Color3.fromRGB(255, 105, 180);
	...
	CloseSettings.ImageColor3 = Color3.fromRGB(255, 105, 180);
	...
	SettingsButton.ImageColor3 = Color3.fromRGB(255, 105, 180);
	...
	TitleSettings.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
	...
	TitleSettings.TextColor3 = Color3.fromRGB(255, 105, 180);
	...
	function CreateCheckbox(title, state, callback)
		...
		Checkbox.ImageColor3 = Color3.fromRGB(255, 105, 180);
		CreateRounded(Checkbox, 5);
		Checkbox.MouseButton1Click:Connect(function()
			checked = not checked;
			if checked then
				Checkbox.ImageTransparency = 0;
				Checkbox.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			else
				Checkbox.ImageTransparency = 1;
				Checkbox.BackgroundColor3 = Color3.fromRGB(100, 100, 100);
			end;
	...
	MainPage.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
	...
	function uitab:Tab(text, img)
		...
		IDK.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
		...
		function main:Button(text, callback)
			...
			ImageLabel.ImageColor3 = Color3.fromRGB(255, 105, 180);
			CreateRounded(TextButton, 4);
			TextButton.Name = "TextButton";
			TextButton.Parent = Button;
			TextButton.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			...
			ArrowRight.ImageColor3 = Color3.fromRGB(255, 105, 180);
			Black.Name = "Black";
			Black.Parent = Button;
		...
		function main:Toggle(text, config, desc, callback)
			...
			Title2.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			Title2.BackgroundTransparency = 1;
			Title2.Size = UDim2.new(1, 0, 0, 35);
			Title2.Font = Enum.Font.Cartoon;
			Title2.Text = text;
			Title2.TextColor3 = Color3.fromRGB(255, 105, 180);
			Title2.TextSize = 15;
			...
			ToggleImage.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
		...
		function main:Dropdown(text, option, var, callback)
			...
			DropTitle.Text = text;
			DropTitle.TextColor3 = Color3.fromRGB(255, 105, 180);
			...
			SelectItems.TextColor3 = Color3.fromRGB(255, 105, 180);
			...
			ArrowDown.ImageColor3 = Color3.fromRGB(255, 105, 180);
			...
			DropScroll.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			...
			for i, v in next, option do
				...
				Item.TextColor3 = Color3.fromRGB(255, 105, 180);
				Item.TextSize = 13;
		...
		function main:Slider(text, min, max, set, callback)
			...
			ValueText.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			...
			ValueText.TextColor3 = Color3.fromRGB(255, 105, 180);
			ValueText.TextSize = 12;
			ValueText.TextXAlignment = Enum.TextXAlignment.Right;
			bar.Name = "bar";
			bar.Parent = sliderr;
			bar.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			...
			circlebar.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
		...
		function main:Textbox(text, disappear, callback)
			...
			TextboxLabel.TextColor3 = Color3.fromRGB(255, 105, 180);
			TextboxLabel.TextSize = 15;
			TextboxLabel.TextTransparency = 0;
			TextboxLabel.TextXAlignment = Enum.TextXAlignment.Left;
			RealTextbox.Name = "RealTextbox";
			RealTextbox.Parent = Textbox;
			RealTextbox.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
		...
		function main:Label(text)
			...
			Label.Name = "Label";
			Label.Parent = Frame;
			Label.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			...
			ImageLabel.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			ImageLabel.BackgroundTransparency = 1;
			ImageLabel.ImageTransparency = 0;
		...
		function main:Seperator(text)
			...
			Sep1.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			...
			Sep1.RichText = true;
			Sep1.Text = "kittylol<font color=\"rgb(255, 0, 0)\">kittylol</font>";
			Sep1.TextColor3 = Color3.fromRGB(255, 105, 180);
			Sep1.TextSize = 14;
			Sep2.Name = "Sep2";
			Sep2.Parent = Seperator;
			Sep2.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			...
			Sep2.Text = text;
			Sep2.TextColor3 = Color3.fromRGB(255, 105, 180);
			Sep2.TextSize = 14;
			Sep3.Name = "Sep3";
			Sep3.Parent = Seperator;
			Sep3.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
			...
			Sep3.RichText = true;
			Sep3.Text = "<font color=\"rgb(255, 0, 0)\">kittylol</font>kittylol";
			Sep3.TextColor3 = Color3.fromRGB(255, 105, 180);
			Sep3.TextSize = 14;
		end;
		function main:Line()
			...
			Linee.BackgroundColor3 = Color3.fromRGB(255, 105, 180);
