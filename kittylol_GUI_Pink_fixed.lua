...
function Update:Notify(desc)
	...
	Image.Name = "Icon";
	Image.Parent = Frame;
	Image.BackgroundColor3 = _G.Primary;
...
function Update:StartLoad()
	...
	TitleLoader.TextColor3 = _G.Primary;
	...
	DescriptionLoader.TextColor3 = _G.Primary;
...
function Update:Window(Config)
	...
	NameHub.Parent = Top;
	NameHub.BackgroundColor3 = _G.Primary;
	...
	SubTitle.BackgroundColor3 = _G.Primary;
	...
	SubTitle.TextColor3 = _G.Primary;
	...
	CloseButton.ImageColor3 = _G.Primary;
	...
	ResizeButton.ImageColor3 = _G.Primary;
	...
	CloseSettings.ImageColor3 = _G.Primary;
	...
	SettingsButton.ImageColor3 = _G.Primary;
	...
	TitleSettings.BackgroundColor3 = _G.Primary;
	...
	TitleSettings.TextColor3 = _G.Primary;
	...
	function CreateCheckbox(title, state, callback)
		...
		Checkbox.ImageColor3 = _G.Primary;
		CreateRounded(Checkbox, 5);
		Checkbox.MouseButton1Click:Connect(function()
			checked = not checked;
			if checked then
				Checkbox.ImageTransparency = 0;
				Checkbox.BackgroundColor3 = _G.Primary;
			else
				Checkbox.ImageTransparency = 1;
				Checkbox.BackgroundColor3 = Color3.fromRGB(100, 100, 100);
			end;
	...
	MainPage.BackgroundColor3 = _G.Primary;
	...
	function uitab:Tab(text, img)
		...
		TabButton.TextColor3 = _G.Primary;
		...
		IDK.BackgroundColor3 = _G.Primary;
		...
		function main:Button(text, callback)
			...
			ImageLabel.ImageColor3 = _G.Primary;
			...
			TextButton.TextColor3 = _G.Primary;
			...
			TextLabel.TextColor3 = _G.Primary;
			...
			ArrowRight.ImageColor3 = _G.Primary;
			Black.Name = "Black";
			Black.Parent = Button;
		...
		function main:Toggle(text, config, desc, callback)
			...
			ToggleImage.BackgroundColor3 = _G.Primary;
		...
		function main:Dropdown(text, option, var, callback)
			...
			DropTitle.Text = text;
			DropTitle.TextColor3 = _G.Primary;
			...
			SelectItems.TextColor3 = _G.Primary;
			...
			ArrowDown.ImageColor3 = _G.Primary;
			...
			DropScroll.BackgroundColor3 = _G.Primary;
		...
		function main:Slider(text, min, max, set, callback)
			...
			ValueText.BackgroundColor3 = _G.Primary;
			...
			circlebar.BackgroundColor3 = _G.Primary;
		...
		function main:Textbox(text, disappear, callback)
			...
			TextboxLabel.TextColor3 = _G.Primary;
		...
		function main:Seperator(text)
			...
			Sep1.BackgroundColor3 = _G.Primary;
			...
			Sep1.TextColor3 = _G.Primary;
			Sep1.TextSize = 14;
			Sep2.Name = "Sep2";
			Sep2.Parent = Seperator;
			Sep2.BackgroundColor3 = _G.Primary;
			...
			Sep2.Text = text;
			Sep2.TextColor3 = _G.Primary;
			Sep2.TextSize = 14;
			Sep3.Name = "Sep3";
			Sep3.Parent = Seperator;
			Sep3.BackgroundColor3 = _G.Primary;
		...
		function main:Line()
			...
			Linee.BackgroundColor3 = _G.Primary;
